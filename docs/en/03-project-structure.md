...
The optional localization template lives outside the runtime resource at
`examples/locales/custom.lua`. Copy it into `locales/` under a new name and add
that file to `fxmanifest.lua` when creating a custom locale.
